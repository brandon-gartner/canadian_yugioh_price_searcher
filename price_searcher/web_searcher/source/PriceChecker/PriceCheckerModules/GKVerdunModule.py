...
class GKVerdunModuleClass(WebstoreInterface):
    ...
    #generates the appropriate URL for the program to read them from
     def GenerateUrl(self, cardname):
        ...
        url = "https://www.gamekeeperverdun.com/products/search?q=" + url_name_section
        return url
...
def FormatCardList(productList):
    ...
    for listing in productList:
        ...
        card = ListedItem(name, price, 'GameKeeper Verdun', shippingCost)
